...
agents **631 structured public‑web‑data tools** across 30+ categories — search, maps,
...
This repo also ships a small **stdio** MCP server (`index.mjs`) that exposes the same **631
...
## What you can call (631 tools / 30+ categories)
...
| **Media & entertainment** | 140 | Spotify, Spotify Podcasts, Apple Podcasts, JustWatch, IMDb, Rotten Tomatoes, Box Office Mojo, TMDB, Letterboxd, Discogs, Goodreads — tracks, artists, charts, episodes, where‑to‑watch, titles, ratings, box office, movies & TV, film reviews, music releases, books |
...
- **One key, 631 tools** — search, commerce, social, gaming, finance, and more behind a single MCP endpoint.
