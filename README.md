...
agents **587 structured public‑web‑data tools** across 30+ categories — search, maps,
...
This repo also ships a small **stdio** MCP server (`index.mjs`) that exposes the same **587
...
## What you can call (587 tools / 30+ categories)
...
- **One key, 587 tools** — search, commerce, social, gaming, finance, and more behind a single MCP endpoint.
