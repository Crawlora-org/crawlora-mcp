...
agents **1404 structured public‑web‑data tools** across 153 platform groups — search, maps,
...
This repo also ships a small **stdio** MCP server (`index.mjs`) that exposes the same **1404
...
## What you can call (1404 tools / 12 categories)
...
- **One key, 1404 tools** — search, commerce, social, gaming, finance, and more behind a single MCP endpoint.
