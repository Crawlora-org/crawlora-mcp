...
agents **478 structured public‑web‑data tools** across 30+ categories — search, maps,
...
This repo also ships a small **stdio** MCP server (`index.mjs`) that exposes the same **478
